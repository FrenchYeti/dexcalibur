...
.method private c(Landroid/support/v7/view/menu/h;)V
    ...
    invoke-virtual {v4, v1}, Landroid/support/v7/widget/am;->a(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroid/support/v7/widget/am;->g(I)V

    iget v1, p0, Landroid/support/v7/view/menu/e;->o:I

    invoke-virtual {v4, v1}, Landroid/support/v7/widget/am;->e(I)V
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/widget/am;->c(Z)V

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/am;->a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroid/support/v7/widget/am;->b(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Landroid/support/v7/widget/am;->c(I)V

    invoke-virtual {v4, v3}, Landroid/support/v7/widget/am;->b(Z)V

    invoke-virtual {v4, v8}, Landroid/support/v7/widget/am;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/am;->c(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/am;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/am;->a(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroid/support/v7/view/menu/e$a;-><init>(Landroid/support/v7/widget/am;Landroid/support/v7/view/menu/h;I)V
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/am;->e()Landroid/widget/ListView;
...
.method private h()Landroid/support/v7/widget/am;
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroid/support/v7/widget/am;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public a(Landroid/support/v7/view/menu/h;Z)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/am;->b(Ljava/lang/Object;)V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/am;

    invoke-virtual {v4}, Landroid/support/v7/widget/am;->d()Z
